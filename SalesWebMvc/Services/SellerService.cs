...
namespace SalesWebMvc.Services
{
    public class SellerService
    {
        ...
        {
            return _context.Seller.Include(obj => obj.Department).FirstOrDefault(obj => obj.Id == id); // esse include funciona tipo o join das tabelas, juntando o vendedor com seu departamento
