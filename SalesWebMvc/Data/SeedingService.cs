...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // se entrar no If significa q pelo menos 1 das tabelas estão populadas e fecha o metodo - o Any q verifica isso
            }
            ...
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); //AddRange permite adiconar vários obj d uma vez no banco
